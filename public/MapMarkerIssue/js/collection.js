...
var infoWindowContent = [
    ...
    ['<div class= "info_content">' +
        '<h3>Lumbee Hall</h3>' +
        '<p>416 Braves Drive, Pembroke, NC</p>'+
        '</div>'
    ],
    ['<div class= "info_content">' +
        '<h3>UNCP Bookstore</h3>' +
        '<p>270 Faculty Row, Pembroke, NC</p>'+
        '</div>'
    ],
    ['<div class= "info_content">' +
        '<h3>Chavis University Center</h3>' +
        '<p>209 N Odum Street, Pembroke, NC</p>'+
        '</div>'
    ],
    ['<div class= "info_content">' +
        '<h3>Belk Athletic Complex</h3>' +
        '<p>University Road, Pembroke, NC</p>'+
        '</div>'
    ],
    ['<div class= "info_content">' +
        '<h3>Belk Residence Hall</h3>' +
        '<p>81 Faculty Row, Pembroke, NC</p>'+
        '</div>'
    ]
];